...
set(PRIMEAPI_PATH "${CMAKE_CURRENT_LIST_DIR}")

if (NOT DEFINED LLVM_DIR)
    message(FATAL_ERROR "Must specify LLVM_DIR")
endif()
set(CMAKE_TOOLCHAIN_FILE "${PRIMEAPI_PATH}/PrimeToolchain.cmake")
...
macro(add_prime_library_common name symbol_list base_dol)
    ...
    add_custom_command(
        ...
        WORKING_DIRECTORY "${PRIMEAPI_PATH}/python/"
    )
    ...
    add_custom_command(
        ...
        -s "${PRIMEAPI_PATH}/empty.lst"
        "${CMAKE_CURRENT_BINARY_DIR}/${name}"
        WORKING_DIRECTORY "${PRIMEAPI_PATH}/randomprime/"
